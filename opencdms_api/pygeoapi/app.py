...
from opencdms_api.pygeoapi.api import CustomPyGeoAPI as API
...
def collection_items(collection_id, item_id=None):
    ...
    if item_id is None:
        ...
        return get_response(
            api_.manage_collection_item(request, "update", collection_id, item_id)
        )
    else:
        return get_response(api_.get_collection_item(request, collection_id, item_id))
...
def collection_coverage_domainset(collection_id):
    ...
    :returns: HTTP response
    """
    return get_response(api_.get_collection_coverage_domainset(request, collection_id))
...
def collection_coverage_rangetype(collection_id):
    ...
    :returns: HTTP response
    """
    return get_response(api_.get_collection_coverage_rangetype(request, collection_id))
...
def get_collection_tiles_data(
    ...
    """
    return get_response(
        api_.get_collection_tiles_data(
...
def get_collection_edr_query(collection_id, instance_id=None):
    ...
    return get_response(
        api_.get_collection_edr_query(request, collection_id, instance_id, query_type)
    )
